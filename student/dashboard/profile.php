...
<div class="content-wrapper">
    ...
    <form action="updateprofiledb.php?r=<?php echo $row['s_id']?>" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" name="username" value="<?php echo $row['s_username']?>" class="form-control" placeholder="Enter teacher username" disabled>
                  </div>
                  <div class="form-group" onclick="myFunction()">
                    <label>Password</label>
                    <input type="password" name="password" value="<?php echo $row['s_password']?>" class="form-control" placeholder="Enter teacher password" id="myinput">
                  </div>
